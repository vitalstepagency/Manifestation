-- Create manifestation_nodes table for 3D Universe persistence
-- This table stores user's dreams, goals, and milestones with 3D positions
...
CREATE TABLE manifestation_nodes (
  ...
  -- Visual customization (matches React Three Fiber properties)
